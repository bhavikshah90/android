package com.example.bhavikshah.notes;
...
static ArrayAdapter arrayAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        sharedPreferences = getApplicationContext().getSharedPreferences("com.example.bhavikshah.notes", Context.MODE_PRIVATE);
